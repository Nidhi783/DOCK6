...
The receptor molecular surface used for sphere generation is: 1J3K_chainA_receptor_WRAremoved.dms
...
The file 1J3K_negative_site_reference.mol2 is intentionally retained as an input because it defines the exact negative-control location used in this project:[39.053, 17.088, 2.043] Å
